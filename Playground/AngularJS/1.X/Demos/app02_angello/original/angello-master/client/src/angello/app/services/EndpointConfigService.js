angular.module('Angello.Common')
    ...
    .service('EndpointConfigService', function($rootScope, CURRENT_BACKEND) {
        var service = this,
            endpointMap = {
                firebase: { URI: 'https://angello-9c30d.firebaseio.com/', root: 'clients/', format: '.json', "Access-Control-Allow-Headers" : "Origin, X-Requested-With, Content-Type, Accept" , 'Access-Control-Allow-Origin': '*' },
